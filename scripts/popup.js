...
document
  ...
  .addEventListener("change", e => setStorage("repeat", e.target.checked));
document
  .getElementById("repeat-threshold")
  .addEventListener("change", e => setStorage("repeatThreshold", e.target.value));
document
  .getElementById("promotion")
  .addEventListener("change", e => setStorage("promotion", e.target.checked));
document
  .getElementById("verified")
  .addEventListener("change", e => setStorage("verified", e.target.checked));
document
  .getElementById("emoji")
  .addEventListener("change", e => setStorage("emoji", e.target.checked));
document
  .getElementById("duplicate")
  .addEventListener("change", e => setStorage("duplicate", e.target.checked));
